// Accordion (copy) - Updated February 29, 2024
function noop() { }
const identity = x => x;
...
function create_if_block(ctx) {
	...
	return {
		...
		h() {
			...
			attr(div, "key", div_key_value = "items[" + /*i*/ ctx[8] + "].description");
		},
		m(target, anchor) {
		...
		p(ctx, dirty) {
			...
			if (!current || dirty & /*items*/ 1 && div_key_value !== (div_key_value = "items[" + /*i*/ ctx[8] + "].description")) {
...
function create_fragment(ctx) {
	...
	let current;
	let if_block = /*heading*/ ctx[1] && create_if_block_1(ctx);
	...
	return {
		...
		h() {
			attr(div, "class", "accordion svelte-70t6t3");
