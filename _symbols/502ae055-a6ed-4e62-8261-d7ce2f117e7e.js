// Page List - Updated February 29, 2024
function noop() { }
...
// (104:12) {#if get_title(page) || get_description(page)}
...
// (97:24)        <Icon width="50" icon="line-md:loading-twotone-loop" />     {:then pages}
