// Accordion - Updated December 31, 2023
function noop() { }
const identity = x => x;
...
function create_if_block(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (!current || dirty & /*items*/ 1 && div_data_key_value !== (div_data_key_value = "items[" + /*i*/ ctx[8] + "].description")) {
...
function create_each_block(key_1, ctx) {
	...
	return {
		...
		p(new_ctx, dirty) {
			...
			if (!current || dirty & /*items*/ 1 && span0_data_key_value !== (span0_data_key_value = "items[" + /*i*/ ctx[8] + "].title")) {
