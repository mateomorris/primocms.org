...
function create_if_block_1(ctx) {
	...
	return {
		...
		h() {
			attr(a, "class", "link svelte-1eizu3");
		...
		p(ctx, dirty) {
			if (dirty & /*teasers*/ 2 && t_value !== (t_value = /*teaser*/ ctx[4].link.label + "")) set_data(t, t_value);

			if (dirty & /*teasers*/ 2 && a_href_value !== (a_href_value = /*teaser*/ ctx[4].link.url)) {
...
function create_else_block(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*teasers*/ 2 && !src_url_equal(img.src, img_src_value = /*teaser*/ ctx[4].image.url)) {
				attr(img, "src", img_src_value);
			}

			if (dirty & /*teasers*/ 2 && img_alt_value !== (img_alt_value = /*teaser*/ ctx[4].image.alt)) {
...
function create_if_block(ctx) {
	...
	return {
		...
		h() {
			...
			attr(iframe, "class", "svelte-1eizu3");
		},
		m(target, anchor) {
			insert_hydration(target, iframe, anchor);
		},
		p(ctx, dirty) {
			if (dirty & /*teasers*/ 2 && !src_url_equal(iframe.src, iframe_src_value = "https://player.vimeo.com/video/" + /*teaser*/ ctx[4].video + "?h=c4704a8ede&autoplay=1&muted=1&loop=1&autopause=0")) {
...
function create_each_block(ctx) {
	...
	let figure;
	let t4;
	let if_block0 = /*teaser*/ ctx[4].link.label && create_if_block_1(ctx);

	function select_block_type(ctx, dirty) {
		if (/*teaser*/ ctx[4].video) return create_if_block;
	...
	return {
		...
		h() {
			attr(h2, "class", "heading svelte-1eizu3");
			attr(div0, "class", "body");
			attr(div1, "class", "content svelte-1eizu3");
			attr(figure, "class", "svelte-1eizu3");
			attr(div2, "class", "teaser svelte-1eizu3");
		},
		m(target, anchor) {
		...
		p(ctx, dirty) {
			if (dirty & /*teasers*/ 2 && t0_value !== (t0_value = /*teaser*/ ctx[4].title + "")) set_data(t0, t0_value);
			if (dirty & /*teasers*/ 2 && raw_value !== (raw_value = /*teaser*/ ctx[4].body.html + "")) div0.innerHTML = raw_value;
...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			attr(h2, "class", "heading svelte-1eizu3");
			attr(h3, "class", "subheading svelte-1eizu3");
			attr(header, "class", "svelte-1eizu3");
			attr(div, "class", "teasers svelte-1eizu3");
			attr(section, "class", "section-container svelte-1eizu3");
		},
		m(target, anchor) {
...
function instance($$self, $$props, $$invalidate) {
	...
	return [heading, teasers, subheading, props];
}
